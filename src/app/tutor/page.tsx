      ...
      <section className="bg-green-100 text-black px-6 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="max-w-lg">
            ...
            <p className="mb-6">
              Share your expertise and connect with global learners.
            </p>
            <button
      ...
      <section className="bg-teal-700 text-white px-6 py-12">
        ...
        <div className="space-y-6 md:space-y-0 md:flex md:justify-around">
          <div className="max-w-sm">
            ...
            <p className="mt-2">
              Teach on your terms! Set your availability and enjoy the freedom
              to manage your time.
            </p>
          </div>
          <div className="max-w-sm">
          ...
          <div className="max-w-sm">
            ...
            <p className="mt-2">
              Expand your horizons by connecting with eager students from around
              the world.
            </p>
          </div>
        </div>
